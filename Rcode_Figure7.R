...
##Figure 7B
fetal_SE <- read.table("Figure5/human_fetal_SE_PA_coupling_0622.txt", sep = "\t", header = T, stringsAsFactors = FALSE)
fetal_SE$type <- "fetal_se_sig"
fetal_SE$type[which(fetal_SE$FDR >= 0.05)] = "fetal_se_nonsig"
adult_SE  <- read.table("Figure5/human_encode_SE_PA_coupling_0622.txt", sep = "\t", header = T, stringsAsFactors = FALSE)
...
rmats <- read.table("Figure7/SE.MATS.JCEC.txt", sep = "\t", header = T, stringsAsFactors = FALSE)
...
##Figure 7C
apalyzer_UTR <- read.table("Figure7/APAlyzer/3UTRAPA.diff.txt", sep = "\t", header = T, stringsAsFactors = FALSE)
apalyzer_IPA <- read.table("Figure7/APAlyzer/IPAmuti.diff.txt", sep = "\t", header = T, stringsAsFactors = FALSE)
